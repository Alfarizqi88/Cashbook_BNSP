package com.project.bnsp_cash_book;
...
import com.project.bnsp_cash_book.DataBase.DataBaseAccess;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DetailActivity.this, com.project.bnsp_cash_book.MenuActivity.class));
            }
        });
    }
    ...
    private void getData() {
        ...
        if(data.getCount() == 0){
            ...
            listView.setAdapter(new com.project.bnsp_cash_book.AdapterDetail(DetailActivity.this, Nominal, Keterangan, Tanggal, Flow));
        }
    }
